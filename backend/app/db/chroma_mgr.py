...
class ChromaManager:
    ...
    def __init__(self, persist_directory: str | None = None, collection_name: str = "kb_documents") -> None:
    ...
    def query(self, *, query_text: str, n_results: int = 5, where: dict[str, Any] | None = None) -> dict[str, Any]:
